...
function accuracyVFI()
  ...
  ax[:plot](p.b_grid, sol_v[1][:,1], linestyle=":", color = "dodgerblue")
  ax[:plot](p.b_grid, sol_v[1][:,2], linestyle=":", color = "darkblue")
  ax[:plot](p.b_grid, sol_p[1][:,1], color = "dodgerblue")
  ax[:plot](p.b_grid, sol_p[1][:,2], color = "darkblue")
  xlabel(L"$b$")
  ...
  ax[:plot](p.a_grid, sol_v[2][:,1], linestyle=":", color = "dodgerblue")
  ax[:plot](p.a_grid, sol_v[2][:,2], linestyle=":", color = "darkblue")
  ax[:plot](p.a_grid, sol_p[2][:,1], color = "dodgerblue")
  ax[:plot](p.a_grid, sol_p[2][:,2], color = "darkblue")
  xlabel(L"$a$")
  legend(["VFI, poor", "VFI, rich", "Ana., poor", "Ana. rich"])
  title("Transfer")
  legend()
