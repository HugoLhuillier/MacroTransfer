...
function accuracyVFI()
  ...
  ax[:plot](p.b_grid, sol_v[1][:,1], linestyle=":", color = "lightsalmon")
  ax[:plot](p.b_grid, sol_v[1][:,2], linestyle=":", color = "indianred")
  ax[:plot](p.b_grid, sol_p[1][:,1], color = "salmon")
  ...
  ax[:plot](p.a_grid, sol_v[2][:,1], linestyle=":", color = "lightsalmon")
  ax[:plot](p.a_grid, sol_v[2][:,2], linestyle=":", color = "indianred")
  ax[:plot](p.a_grid, sol_p[2][:,1], color = "salmon")
